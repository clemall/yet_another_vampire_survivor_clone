...
//         Entity,
//         &mut AttackAmmo), (With<ArcaneMissileSpawner>, Without<AttackReloadDuration>)>,
// ){
...
//         &mut AttackAmmo), (With<ArcaneMissileSpawner>, With<AttackReloadDuration>)>,
//     time: Res<Time>,
// ){
...
//     mut arcane_missile_spawner: Query<(&mut AttackDelayBetweenAttacks, &mut AttackAmmo),(With<ArcaneMissileSpawner>, Without<AttackReloadDuration>)>,
//     enemies: Query<(Entity, &Transform),With<Enemy>>,
//     mut projectile_offset_bool: ResMut<ProjectileBendLeftOrRight>,
//     time: Res<Time>,
// ){
